...
우아한 테크코스 7기 프리코스의 4주차 미션, 편의점 결제 시스템을 개발한 저장소입니다.

이 프로젝트는 매장의 상품들 중 사용자가 원하는 상품을 원하는 개수만큼 주문하고,
프로모션 혜택과 멤버십 혜택을 적용해 최종 주문 결과를 영수증으로 출력하는 프로그램입니다. 주요 기능은 다음과 같습니다.

- **상품 주문**: 상품 목록을 보고 사용자는 구매하고싶은 상품의 이름과 수량을 입력합니다.
- **프로모션 혜택과 멤버십 혜택 적용**: 구매 상품 및 금액에 따라 적용 가능한 프로모션 혜택과 멤버십 혜택이 적용됩니다.
프로모션은 1+1 또는 2+1의 증정형 할인 혜택이고, 멤버십 혜택은 프로모션이 적용되지 않은 금액의 30%가 할인됩니다.
- **영수증 출력**: 주문이 완료되면, 사용자의 구매 내역과 할인 내역을 요약하여 출력합니다. 
영수증의 항목에는 구매 상품, 증정 상품, 총구매액, 행사할인, 멤버십할인, 내실돈이 포함되어있습니다.
- **재고 관리**: 상품 주문시 구매 가능한 재고 수량을 파악하고, 재주문시 이전에 구매한 수량이 차감된 상품 목록을 확인할 수 있습니다.
